...
const _animalSelect = document.querySelector('#animal')
...
function startGame(level) {
  ...
  switch (level) {
    case 'demo':
      ...
      images = animalTypeImages.slice(0, 6)
      break
    case 'easy':
      numberOfRemainingPairs = 10
      images = animalTypeImages.slice(0, 20)
      break
    case 'medium':
      numberOfRemainingPairs = 15
      images = animalTypeImages.slice(0, 30)
      break
    case 'hard':
      numberOfRemainingPairs = 21
      images = [...animalTypeImages]
      break
  }
  levelClass = level
